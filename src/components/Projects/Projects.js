  ...
  return (
    <div>
      <div className="About flex justify-center pt-[2%] z-[1] bg-[#21272c]/40">
        <TypeAnimation
          sequence={["Most Recent Works", 2000]}
          wrapper="p"
          repeat={1}
          cursor={true}
      ...
      <h1 className="flex justify-center text-slate-200 text-2xl pt-2 bg-[#21272c]/40">
